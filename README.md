...
- **Autenticación**: Google OAuth 2.0 (opcional).
...
3. **Configura el entorno**:
   ...
   VITE_GOOGLE_CLIENT_ID=tu_client_id_aca
   ```
...
- **Procesamiento de IA**: El procesamiento de las consultas se realiza a través de las APIs oficiales de Groq Cloud (y opcionalmente Google Generative AI), y el uso de las mismas está sujeto a sus propias políticas de privacidad.
